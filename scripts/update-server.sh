...
# data/price-data/*.json é a fonte histórica versionada. O importer é idempotente:
# snapshots já processados não são duplicados. Se houver erro, NÃO reiniciamos o
# serviço, preservando o estado anterior e o backup feito no início.
