...
PRICE_DB_PATH=Path(os.environ.get("FILAMENT_PRICE_DB_PATH",str(ROOT/"price-history.db")))
SCHEMA_PATH=ROOT/"price-history"/"schema.sql"
SEED_PATH=ROOT/"price-history"/"seed.json"
